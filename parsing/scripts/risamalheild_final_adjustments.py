...
output = re.sub(r"\(NUM-([A-Z0-9-]+) 20-20\)", r"(NUM-\1 30-þrjátíu)", output)
output = re.sub(r"\(NUM-([A-Z0-9-]+) 20-20\)", r"(NUM-\1 40-fjörutíu)", output)
output = re.sub(r"\(NUM-([A-Z0-9-]+) 20-20\)", r"(NUM-\1 50-fimmtíu)", output)
output = re.sub(r"\(NUM-([A-Z0-9-]+) 20-20\)", r"(NUM-\1 60-sextíu)", output)
output = re.sub(r"\(NUM-([A-Z0-9-]+) 20-20\)", r"(NUM-\1 70-sjötíu)", output)
output = re.sub(r"\(NUM-([A-Z0-9-]+) 20-20\)", r"(NUM-\1 80-áttatíu)", output)
output = re.sub(r"\(NUM-([A-Z0-9-]+) 20-20\)", r"(NUM-\1 90-níutíu)", output)
output = re.sub(r"\(NUM-([A-Z0-9-]+) 20-20\)", r"(NUM-\1 100-hundrað)", output)
